...
ctx->_eglGetCompositorTimingSupportedANDROID = (PFNEGLGETCOMPOSITORTIMINGSUPPORTEDANDROIDPROC)get_proc(libgl, "eglGetCompositorTimingSupportedANDROID");
ctx->_eglGetCompositorTimingANDROID = (PFNEGLGETCOMPOSITORTIMINGANDROIDPROC)get_proc(libgl, "eglGetCompositorTimingANDROID");
ctx->_eglGetNextFrameIdANDROID = (PFNEGLGETNEXTFRAMEIDANDROIDPROC)get_proc(libgl, "eglGetNextFrameIdANDROID");
ctx->_eglGetFrameTimestampSupportedANDROID = (PFNEGLGETFRAMETIMESTAMPSUPPORTEDANDROIDPROC)get_proc(libgl, "eglGetFrameTimestampSupportedANDROID");
ctx->_eglGetFrameTimestampsANDROID = (PFNEGLGETFRAMETIMESTAMPSANDROIDPROC)get_proc(libgl, "eglGetFrameTimestampsANDROID");
ctx->_eglGetNativeClientBufferANDROID = (PFNEGLGETNATIVECLIENTBUFFERANDROIDPROC)get_proc(libgl, "eglGetNativeClientBufferANDROID");
...
ctx->_eglClientSignalSyncEXT = (PFNEGLCLIENTSIGNALSYNCEXTPROC)get_proc(libgl, "eglClientSignalSyncEXT");
...
ctx->_eglUnsignalSyncEXT = (PFNEGLUNSIGNALSYNCEXTPROC)get_proc(libgl, "eglUnsignalSyncEXT");
...
ctx->_eglGetDisplayDriverConfig = (PFNEGLGETDISPLAYDRIVERCONFIGPROC)get_proc(libgl, "eglGetDisplayDriverConfig");
ctx->_eglGetDisplayDriverName = (PFNEGLGETDISPLAYDRIVERNAMEPROC)get_proc(libgl, "eglGetDisplayDriverName");
...
ctx->_eglStreamFlushNV = (PFNEGLSTREAMFLUSHNVPROC)get_proc(libgl, "eglStreamFlushNV");
